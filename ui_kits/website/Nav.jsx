                ...
                <button type="button" className="bell-trigger"
                  ...
                  {unread > 0 && (
                    <span aria-hidden="true"
                      style={{position:'absolute',top:-4,right:-4,minWidth:16,height:16,padding:'0 4px',borderRadius:999,background:'var(--badge-danger-fill)',color:'var(--fg-on-fill)',fontSize:10,fontWeight:700,display:'inline-flex',alignItems:'center',justifyContent:'center',fontFamily:'var(--font-mono)'}}>
                      {unread > 9 ? '9+' : unread}
                    </span>
                  )}
                </button>
